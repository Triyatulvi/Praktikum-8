                ...
                <div class="card-body">
                    <form method="post" action="prosesdataayah.php">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="namaayah" id="namaayah"
                                    class="form-control <?php echo ($error_namaayah !="" ? "is-invalid" : ""); ?>"
                                    placeholder="" value="<?php echo $namaayah; ?>"> <span
                                    class="warning"><?php echo $error_namaayah ?></span>
                            </div>
                        </div><br>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="tlayah" id="tlayah"
                                    class="form-control <?php echo ($error_tlayah !="" ? "is-invalid" : ""); ?>"
                                    placeholder="" value="<?php echo $tlayah; ?>"> <span
                                    class="warning"><?php echo $error_tlayah ?></span>
                            </div>
                        </div><br>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="radio" name="salaryayah" value="< 500.000">
                                < 500.000 </label> <br>
                                    <input type="radio" name="salaryayah" value="500.000 - 999.9999"> 500.000 - 999.9999
                                    </label><br>
                                    <input type="radio" name="salaryayah" value="1.000.000 - 1.999.999"> 1.000.000 -
                                    1.999.999 </label><br>
                                    <input type="radio" name="salaryayah" value="2.000.000 - 4.999.999"> 2.000.000 -
                                    4.999.999 </label><br>
                                    <input type="radio" name="salaryayah" value="5.0000.000 - 20.000.000"> 5.0000.000 -
                                    20.000.000 </label> <br>
