                ...
                <div class="card-body">
                    <form method="post" action="prosesdataibu.php">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="namaibu" id="namaibu"
                                    class="form-control <?php echo ($error_namaibu !="" ? "is-invalid" : ""); ?>"
                                    placeholder="" value="<?php echo $namaibu; ?>"> <span
                                    class="warning"><?php echo $error_namaibu ?></span>
                            </div>
                        </div><br>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="tlibu" id="tlibu"
                                    class="form-control <?php echo ($error_tlibu !="" ? "is-invalid" : ""); ?>"
                                    placeholder="" value="<?php echo $tlibu; ?>"> <span
                                    class="warning"><?php echo $error_tlibu ?></span>
                            </div>
                        </div><br>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="radio" name="penghasilan" value="< 500.000">
                                < 500.000 </label> <br>
                                    <input type="radio" name="penghasilan" value="500.000 - 999.9999"> 500.000 -
                                    999.9999
                                    </label><br>
                                    <input type="radio" name="penghasilan" value="1.000.000 - 1.999.999"> 1.000.000 -
                                    1.999.999 </label><br>
                                    <input type="radio" name="penghasilan" value="2.000.000 - 4.999.999"> 2.000.000 -
                                    4.999.999 </label><br>
                                    <input type="radio" name="penghasilan" value="5.0000.000 - 20.000.000"> 5.0000.000 -
                                    20.000.000 </label> <br>
